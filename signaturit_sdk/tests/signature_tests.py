...
class SignatureTest(unittest.TestCase):
    ...
    def test_send_signature_reminder(self):
        httpretty.register_uri(
            httpretty.POST,
            "http://api.sandbox.signaturit.com/v2/signs/SIGN_ID/documents/JOB_ID/reminder.json",
            body="{}",
            content_type="application/json",
        )
    ...
    def test_get_signatures(self):
        httpretty.register_uri(
            httpretty.GET,
            "http://api.sandbox.signaturit.com/v2/signs.json",
    ...
    def test_count_signatures(self):
        httpretty.register_uri(
            httpretty.GET,
            "http://api.sandbox.signaturit.com/v2/signs/count.json",
            body="3",
            content_type="application/json",
        )
    ...
    def test_get_signature(self):
        httpretty.register_uri(
            httpretty.GET,
            "http://api.sandbox.signaturit.com/v2/signs/SIGN_ID.json",
            body='{"id": "SIGN_ID", '
